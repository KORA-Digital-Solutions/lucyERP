-- La fecha del recordatorio pasa a ser opcional: los que no la tienen son
-- permanentes (avisos de la ficha que no vencen solos, como una alergia).
-- Los recordatorios que ya existen tienen fecha, así que no cambia ninguno.
...
INSERT INTO "new_CustomerReminder" ("alertDaysBefore", "clinicId", "completedAt", "completedByUserId", "createdAt", "createdByUserId", "customerId", "dueDate", "id", "title", "updatedAt") SELECT "alertDaysBefore", "clinicId", "completedAt", "completedByUserId", "createdAt", "createdByUserId", "customerId", "dueDate", "id", "title", "updatedAt" FROM "CustomerReminder";
