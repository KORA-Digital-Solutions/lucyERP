...
CREATE TABLE "new_SaleLine" (
    ...
    CONSTRAINT "SaleLine_appointmentId_fkey" FOREIGN KEY ("appointmentId") REFERENCES "Appointment" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_SaleLine" ("description", "discountPercent", "durationMinutes", "id", "notes", "productId", "quantity", "saleId", "serviceId", "totalCents", "type", "unitPriceCents", "workerId") SELECT "description", "discountPercent", "durationMinutes", "id", "notes", "productId", "quantity", "saleId", "serviceId", "totalCents", "type", "unitPriceCents", "workerId" FROM "SaleLine";
DROP TABLE "SaleLine";
ALTER TABLE "new_SaleLine" RENAME TO "SaleLine";
CREATE UNIQUE INDEX "SaleLine_appointmentId_key" ON "SaleLine"("appointmentId");
